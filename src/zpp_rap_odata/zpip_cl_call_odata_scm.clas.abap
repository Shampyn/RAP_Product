...
CLASS ZPIP_CL_CALL_ODATA_SCM IMPLEMENTATION.
  ...
  METHOD get_business_partners.
    ...
    DATA(lo_destination) = cl_http_destination_provider=>create_by_url( i_url = 'https://ecsc00a022b7.epam.com' ).
    ...
    read_list_request = lo_client_proxy->create_resource_for_entity_set('A_BUSINESSPARTNER')->create_request_for_read( ).
